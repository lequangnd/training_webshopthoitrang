                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0"
                    ...
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link" data-toggle="dropdown">Thời trang <i
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    ...
                                    <a href="{{route('category', ['id' =>$categories_male->id]).'?fashion=0'}}"
                                        class="dropdown-item">{{$categories_male->name}}</a>
                                    @endforeach
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    @foreach($categories as $categories_female)
                                    <a href="{{route('category', ['id' =>$categories_female->id]).'?fashion=1'}}"
                                        class="dropdown-item">{{$categories_female->name}}</a>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div class="navbar-nav ml-auto py-0">
                            ...
                            <a href="{{route('bills')}}" class="nav-item nav-link">Đơn hàng</a>
